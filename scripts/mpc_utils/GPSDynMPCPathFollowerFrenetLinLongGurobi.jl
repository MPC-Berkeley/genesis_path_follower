...
module GPSDynMPCPathFollowerFrenetLinLongGurobi
	__precompile__()
	...
	println("Creating longitudinal dynamic bicycle model in Gurobi ....")
	...
	v_ref_init = ones(N,1)						# reference velocity vx
	...
	# a_opt, a_pred, s_pred, vx_pred, solv_time_long, is_opt_long = dmpcLinLongGurobi.solve_gurobi(s_curr, vx_curr, prev_a, s_ref, v_ref)
  ...
  #       println("u0 in Gurobi: $(u_0)")
		...
		# println("s_ref in long: $(s_ref')")
		# println("v_ref in long: $(v_ref')")
