...
from anim_utils.anim_empc import AnimateEMPC
...
if __name__=='__main__':
	...
	parser.add_argument('--type', type=str, choices=['track', 'vehicle', 'empc'], help='Plot full track or zoomed-in view of vehicle.')
	...
	if args.type == 'track':
		...
		AnimateEMPC(args.bag, args.mat, args.vid)
	else:
