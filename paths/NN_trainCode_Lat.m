...
load('NN_test_trainingDataLat10k_PrimalDual2.mat');
x_nn_train = inputParam_lat'; 
y_nn_train = outputParamDdf_lat'; 
y_nn_train_dual = outputParamDual_lat';
...
maxTrials_fixedStructure = 2;                 % max number of fitting trials for given networkSize
...
%         net.output.processFcns = {'mapminmax'};
 ...
 [net, tr] = train(net,x_nn_train,y_nn_train,'useGPU','no','useParallel','no');
