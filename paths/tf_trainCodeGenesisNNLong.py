...
df = sio.loadmat('NN_test_trainingDataLong10k_RegDual2_1e-7.mat',squeeze_me=True, struct_as_record=False) # read data set using pandas
...
#  Getting the variables from the Neural Nets
     ...
     sio.savemat('trained_weightsDualLongRegDual1e-7.mat',vjD)
