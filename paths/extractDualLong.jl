...
import KinMPCParams
# const kmpcLinLong = GPSKinMPCPathFollowerFrenetLinLongNN  # short-hand-notation
...
rand_count = 10000				# number of training data samples randomly generated 

# s_lb = 0 
# s_ub = 500
# s_train_rand = s_lb + (s_ub-s_lb)*rand(rand_count,1) 

# v_lb = 0 
# v_ub = 500
# v_train_rand = v_lb + (v_ub-v_lb)*rand(rand_count,1) 
